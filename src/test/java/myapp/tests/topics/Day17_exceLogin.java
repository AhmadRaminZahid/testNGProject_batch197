...
//    Then verify the name field contains first name
    ...
    List<Map<String, String>> dataList; // Create an empty List and initialise it inside the test method TO STORE DATA from Excel sheet and use it for the test
    //    WITHOUT EXCEL
    @Test
...
//    Click on the new button
//        Create the DataTablesPage object to acces the elements
