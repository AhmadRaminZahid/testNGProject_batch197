...
//    DataProvider Method 1
    ...
    @DataProvider (name= "employee_credentials")  // you can also give a customised name to @DataProvider and use that to connect with TEST METHOD
    ...
    //    Test Method 2
    @Test (dataProvider = "credentialProvider") // call the DataProvider Method by its name and connect with the test method
    ...
    //    Test Method 3
    @Test (dataProvider = "employee_credentials") // You can ALSO call the DataProvider Method by its customised name
